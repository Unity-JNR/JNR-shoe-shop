...
<div class="row">
 <div class="column">
    ...
    <label for="price">R<?php echo $nike1 ?></label>
 ...
 <div class="column">
    ...
    <label for="price">R<?php echo $nike2 ?></label>
    <form method="post" action="">
 ...
 <div class="column">
    ...
    <label for="price">R<?php echo $nike3 ?></label>
    <form method="post" action="">
 ...
 <div class="column">
    ...
    <label for="price">R<?php echo $nike4 ?></label>
    <form method="post" action="">
